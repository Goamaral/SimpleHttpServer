...
int printInvalidConfigFile(void) {
  printf("\nMissing assignment = sign in one of the attributions in the config "
  ...
  printf("ALLLOWED=(allowed file names seperated by ; sign) -> "
         "file_a.html;file_b.html\n");
